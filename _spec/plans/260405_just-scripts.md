...
A new `Elr.Script` module (or function group in an existing module) encapsulates the two validation rules:
...
16. **Implement `Elr.Datastore` module**
...
22. **Update `Elr.Resolver` for script-only resolution**
    - Files: `lib/elr/resolver.ex`
